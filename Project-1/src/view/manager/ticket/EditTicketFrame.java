 ...
 */
public class EditTicketFrame extends javax.swing.JFrame {
    private Ticket ticket;
    /**
     * Creates new form EditTicketFrame
     */
    public EditTicketFrame() {
        initComponents();
        setLocationRelativeTo(null);
    }
    
    public EditTicketFrame(Ticket ticket){
        initComponents();
        setLocationRelativeTo(null);
        this.ticket = ticket;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Chỉnh sửa phiếu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditTicketFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditTicketFrame().setVisible(true);
            }
        });
    }
